...
<head>
    ...
    <title>Review Room {{ $room->room_number }} - BookMyStay</title>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <h5>Room {{ $room->room_number }} - {{ $room->type }}</h5>
                        ...
                        <form action="{{ route('user.reviews.store-room', $room->id) }}" method="POST">
                            @csrf
