...
<head>
    ...
    <title>Admin - Create Special Offer</title>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.special-offers.store') }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control @error('max_uses') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('max_uses', 100) }}" placeholder="Leave empty for unlimited">
                                                @error('max_uses')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                ...
                                                <select class="form-control @error('applicable_hotels') is-invalid @enderror" 
                                                    ...
                                                    @foreach($hotels as $hotel)
                                                        <option value="{{ $hotel->id }}" 
                                                            {{ in_array($hotel->id, old('applicable_hotels', [])) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('applicable_room_types') is-invalid @enderror" 
                                            ...
                                            <option value="Standard" {{ in_array('Standard', old('applicable_room_types', [])) ? 'selected' : '' }}>Standard</option>
                                            <option value="Deluxe" {{ in_array('Deluxe', old('applicable_room_types', [])) ? 'selected' : '' }}>Deluxe</option>
                                            <option value="Suite" {{ in_array('Suite', old('applicable_room_types', [])) ? 'selected' : '' }}>Suite</option>
                                            <option value="Executive" {{ in_array('Executive', old('applicable_room_types', [])) ? 'selected' : '' }}>Executive</option>
                                            <option value="Presidential" {{ in_array('Presidential', old('applicable_room_types', [])) ? 'selected' : '' }}>Presidential</option>
                                        </select>
