...
<body>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control @error('size') is-invalid @enderror" 
    ...
    <script>
        $(document).ready(function() {
            // Auto-generate room number based on hotel selection
            $('#hotel_id').change(function() {
                var hotelId = $(this).val();
                if (hotelId) {
                    // You can implement AJAX call to get next available room number
                    // For now, we'll just clear the room number field
                    $('#room_number').val('');
                }
            });
