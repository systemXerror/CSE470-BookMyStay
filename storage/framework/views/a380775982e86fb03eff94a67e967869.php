        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 bg-dark text-white p-3 min-vh-100">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link text-white" href="<?php echo e(route('admin.hotels')); ?>">
                        <i class="fas fa-building me-2"></i>Hotels
                    </a>
                    <a class="nav-link text-white" href="<?php echo e(route('admin.bookings')); ?>">
                        <i class="fas fa-calendar-check me-2"></i>Bookings
                    </a>
                    <a class="nav-link text-white" href="<?php echo e(route('admin.users')); ?>">
                        <i class="fas fa-users me-2"></i>Users
                    </a>
                    <hr class="my-3">
                    <a class="nav-link text-white" href="<?php echo e(route('user.hotels')); ?>">
...
<?php /**PATH D:\Xampp\htdocs\hotel_management\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>