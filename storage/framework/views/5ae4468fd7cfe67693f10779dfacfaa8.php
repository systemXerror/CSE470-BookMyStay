                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="booking-detail">
                                        ...
                                        <span class="badge bg-primary fs-6">#<?php echo e($booking->id); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Hotel:</strong></span>
                                        <span><?php echo e($booking->room->hotel->name); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Room Type:</strong></span>
                                        <span><?php echo e($booking->room->room_type); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Check-in Date:</strong></span>
                                        <span><?php echo e($booking->check_in_date->format('F j, Y')); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Check-out Date:</strong></span>
                                        <span><?php echo e($booking->check_out_date->format('F j, Y')); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Duration:</strong></span>
                                        <span><?php echo e($booking->nights); ?> <?php echo e($booking->nights == 1 ? 'night' : 'nights'); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Number of Guests:</strong></span>
                                        <span><?php echo e($booking->guests); ?> <?php echo e($booking->guests == 1 ? 'guest' : 'guests'); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                        <span><strong>Total Amount:</strong></span>
                                        <span class="fw-bold text-success">$<?php echo e(number_format($booking->total_amount, 2)); ?></span>
                                    </div>
                                    <div class="booking-detail">
                                    ...
                                    <?php if($booking->special_requests): ?>
                                        <div class="booking-detail">
                                            ...
                                            <span class="text-muted"><?php echo e($booking->special_requests); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-4">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 text-center">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <a href="<?php echo e(route('user.my-bookings')); ?>" class="btn btn-primary me-md-2">
                            <i class="fas fa-list me-2"></i>View All Bookings
                        </a>
                        <a href="<?php echo e(route('user.hotels')); ?>" class="btn btn-outline-primary me-md-2">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-lg-8">
                    <div class="info-card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>Hotel:</strong> <?php echo e($booking->room->hotel->name); ?></p>
                                <p><strong>Address:</strong> <?php echo e($booking->room->hotel->address); ?></p>
                                <p><strong>City:</strong> <?php echo e($booking->room->hotel->city); ?>, <?php echo e($booking->room->hotel->state); ?></p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Phone:</strong> <?php echo e($booking->room->hotel->phone); ?></p>
                                <p><strong>Email:</strong> <?php echo e($booking->room->hotel->email); ?></p>
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
        <div id="bookingToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            ...
            <div class="toast-body">
                Your booking for <?php echo e($booking->room->hotel->name); ?> has been confirmed. Check your email for details.
            </div>
        </div>
    </div>
...
</html> <?php /**PATH D:\Xampp\htdocs\hotel_management\resources\views/user/booking-confirmation.blade.php ENDPATH**/ ?>